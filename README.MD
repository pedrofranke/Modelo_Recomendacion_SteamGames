...
**`ETL`**: Se realizo un ETL de los tres subconjuntos que se encuentran [aca](https://https://github.com/pedrofranke/Modelo_Recomendacion_SteamGames/tree/master/Datasets). De los mismos se 
